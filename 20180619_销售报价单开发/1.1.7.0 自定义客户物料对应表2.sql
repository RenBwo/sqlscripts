...
SELECT      200000026 AS FClassTypeID,FEntryID AS FID, FEntryID
...
-- F_175	USD产品控制利润率%
-- F_172	本型号历史销售数量
-- 测试账套 f_125    发货条件 正式账套是f_124
-- FvalueAddRate 增值税率
--drop view v_ctoimapping2 
create view  v_ctoimapping2 as
SELECT     200000026 AS FClassTypeID, t1.FEntryID AS FID, t1.FEntryID
...
,t3.f_124 as FshipmentCondition,t4.fname as FshipmentConditionName
,t3.fvalueaddrate 
...
left join t_submessage t4 on t3.f_124 = t4.finterid
