...
create table #t2(fbillno	varchar(max),washflag	varchar(max),lastenddate	varchar(max)
,washdate	varchar(max),diffday	varchar(max),finishstatus	varchar(max)
,finishcount varchar(max),sum0	varchar(max),finishrate	varchar(max))

create table #t3(gzl	varchar(max),fbillno	varchar(max),fopreid	varchar(max)
...
,sum0	varchar(max),finishstatus	varchar(max),diffhours	varchar(max)
,finishrate varchar(max))

create table #t4(ftitle	varchar(max),lvgout	varchar(max),pllin	varchar(max),xrate	varchar(max),plout	varchar(max)
,pipein	varchar(max),yrate	varchar(max),factqty	varchar(max),faccountqty	varchar(max),zrate	varchar(max)
,rate	varchar(max))

create table #t5(生产任务单编号	varchar(max),工作令号	 varchar(max),物料代码 	varchar(max),规格型号 varchar(max)
...
create table #t6(生产任务单编号	varchar(max),工作令号	 varchar(max),物料代码 	varchar(max),规格型号 varchar(max)
,生产车间	 varchar(max),生产计量单位	varchar(max),客户特殊要求 varchar(max),客户 varchar(max),计划数量 varchar(max)
...
--select * from t_dachenglv where period = '201806'
