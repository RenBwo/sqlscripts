...
/*
 * DATE:			2017/11/08
 * DESCRIPTION:		审核时,单据分录根据生产任务单号引入刻字要求.
 * AUTHOR:			RENBO
 * 
 * DATE:			2017/08/09
 * AUTHOR:			RENBO
 ...
 * date:			2016/12/06
 * author:			RenBwo
 * Description:		To write the nearest out_date and out_qty into ppbomentry which has the same fdeptid and fitemid
...
begin 
	if  @fstatusIn = 1
	    ...
	    and a.ftrantype = 24
	    join icmo c on b.ficmointerid = c.finterid 
