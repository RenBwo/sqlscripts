...
create table #t2(fbillno	varchar(max),washflag	varchar(max),lastenddate	varchar(max),washdate	varchar(max)
,diffday	varchar(max),finishstatus	varchar(max),finishcount varchar(max),sum0	varchar(max)
,finishrate	varchar(max))

create table #t3(gzl	varchar(max),fbillno	varchar(max),fopreid	varchar(max),fopername	varchar(max)
,fmatename	varchar(max),fqtyplan varchar(max),fqtypass	varchar(max),fplanenddate	varchar(max)
,fendworkdate	varchar(max),finishcount varchar(max),sum0	varchar(max),finishstatus	varchar(max)
,diffhours	varchar(max),finishrate varchar(max))
